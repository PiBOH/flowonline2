...
Developed by PiBOH under AGPL 3.0, this static, client-side application brings the full power of Flowgorithm to any web browser with zero configuration.
...
Sviluppato da PiBOH sotto AGPL 3.0, questo applicativo statico porta tutta la potenza di Flowgorithm nel browser, senza bisogno di alcuna configurazione.
