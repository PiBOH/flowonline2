...
// Mobile uses the same desktop surface in a landscape-oriented viewport.
// MainLayout remains the single source of truth; this wrapper only changes
// presentation when the viewport is narrow.
const AppShell: React.FC = () => {
  const { isMobile } = useViewport();
  return (
    <div className={isMobile ? 'desktop-mobile-mode' : undefined}>
      <MainLayout />
    </div>
  );
};
